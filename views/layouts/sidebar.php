        ...
        <nav class="mt-2">
            ...
            echo \hail812\adminlte\widgets\Menu::widget([
                'items' => [
                    ...
                    ['label' => 'Акции', 'iconStyle' => 'far', 'url' => ['/admin/promotions'], 'visible' => (!Yii::$app->user->isGuest)],
                    ['label' => 'Тарифы', 'iconStyle' => 'far', 'url' => ['/admin/tariffs'], 'visible' => (!Yii::$app->user->isGuest)],
                    ['label' => 'Пользователи', 'iconStyle' => 'far', 'url' => ['/admin/users'], 'visible' => (!Yii::$app->user->isGuest)],
                    ['label' => 'Текстовые страницы', 'iconStyle' => 'far', 'url' => ['/admin/pages'], 'visible' => (!Yii::$app->user->isGuest)],
